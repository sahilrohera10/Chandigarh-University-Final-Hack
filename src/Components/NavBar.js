    ...
    >
      <div className="2xl:container 2xl:mx-auto md:py-5 lg:px-20 md:px-6 p-4">
        <div className="flex items-center justify-between">
          ...
          <div
            style={{ display: "flex" }}
            className="lg:w-6/12 flex flex-row justify-center items-center space-y-3.5"
          >
            <div
            ...
            <div
              style={{ marginLeft: "200px", width: "1760px" }}
                ...
                <li>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                      ...
                      <Link to={`products/${c}`}>Courses</Link>
                      <Link to={`products/${f}`}>Furniture</Link>
                      <Link to={`products/${e}`}>Electronics</Link>
                      <Link to={`products/${o}`}>Other</Link>
                    </div>
                  </div>
                </li>
                <li>
